...
class LedgerViewModel(private val container: AppContainer):ViewModel(){
    ...
    fun removeSpecialLimit(value:SpecialLimitEntity){ viewModelScope.launch { container.limits.deleteSpecial(value) } }
    ...
    fun deleteWinner(value:WinningNumberEntity){ viewModelScope.launch { container.winners.delete(value) } }
    fun addClosedDay(date:LocalDate){ viewModelScope.launch { container.closedDays.add(date) } }
    fun removeClosedDay(value:ClosedDayEntity){ viewModelScope.launch { container.closedDays.remove(value) } }
